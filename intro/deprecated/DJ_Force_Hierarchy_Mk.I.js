/* Register a new custom visualization with loooker by calling the
   ...
   looker.plugins.visualizations.add({
    id: 'Force directed graph d3 collapsable ',
    label: 'First version to a new neo4j graph',
    options: {
        font_size: {
            type: "string",
            label: "Font Size",
...
updateAsync: function(data, element, config, queryResponse, details, doneRendering) { 
    ...
    console.log('D3 force with burrow and scaling ');
        ...
        // Try implementing d3
    console.log('d3v3 initialized', d3);
...
**************************************************************************************************/
    ...
    ********************************************/
 // Simulation physics
 simulation.on('tick', () => { // On each tick, specifify these parameters for this stuff
